...
For Server2, use the complete [deployment guide](docs/SERVER2_DEPLOYMENT.md), [beta.11 upgrade procedure](docs/SERVER2_BETA11_UPGRADE.md), [camera-mode guide](docs/CAMERA_MODES.md), and [camera training instructions](docs/SERVER2_TRAINING.md).
